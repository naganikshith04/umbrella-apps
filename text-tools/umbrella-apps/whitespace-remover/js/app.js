...
function initApp() {
    ...
    const inputText = document.getElementById('inputText');
      ...
      const charsRemoved = document.getElementById('charsRemoved');
    
      removeBtn.addEventListener('click', function() {
        const input = inputText.value;
        const trimmed = input.trim();
        
        outputText.value = trimmed;
        
        originalLength.textContent = input.length;
        trimmedLength.textContent = trimmed.length;
        charsRemoved.textContent = input.length - trimmed.length;
);
      }
